...
import numpy as np
# Importing "CV2" for OpenCV bindings
import cv2
# Importing "imutils" to check opencv version
import imutils

# Definig ColorDescripter Class
class ColorDescripter:
	...
	def describe(self, image):
        ...
        # extract a color histogram from the elliptical region andupdate the feature vector
